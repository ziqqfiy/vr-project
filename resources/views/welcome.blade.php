    ...
    <a-scene fog="type: linear; color: #665A8A; near:5; far:50">
        ...
        <a-entity id="obstacles-container">
            ...
            <a-entity id="top-obstacle" position="0 3.3 0">
                <a-box shadow="cast: true" height="3.7" width="8" depth="5" color="#DE87A4" material="opacity: 1; transparency: true" animation="property: position; from: 0 0 -70; to: 0 0 70; dur: 6000; easing: linear"></a-box>
            </a-entity>

            <!-- Right -->
            <a-entity id="right-obstacle" position="2 2.5 0">
                <a-box shadow="cast: true" height="5" width="4" depth="5" color="#DE87A4" material="opacity: 1; transparency: true" animation="property: position; from: 0 0 -70; to: 0 0 70; dur: 6000; easing: linear"></a-box>
            </a-entity>
            ...
            <a-entity id="top-left-obstacle">
                <a-box shadow="cast: true" height="5" width="4" depth="5" position="-2 2.5 0" color="#DE87A4" material="opacity: 1; transparency: true" animation="property: position; from: -2 2.5 -70; to: -2 2.5 70; dur: 6000; easing: linear"></a-box>
                <a-box shadow="cast: true" height="3.7" width="8" depth="5" position="0 3.3 0" color="#DE87A4" material="opacity: 1; transparency: true" animation="property: position; from: 0 3.3 -70; to: 0 3.3 70; dur: 6000; easing: linear"></a-box>
            </a-entity>
